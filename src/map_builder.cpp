...
std::string node_name = "map_builder";

std::string topic_name_scan = "/scan";
std::string topic_name_tilt_angle = "/head_tilt_joint/command";
std::string topic_name_pose = "/ins/global_position/local";
...
int main(int argc, char** argv){
	...
	ros::Subscriber angle_sub = nh.subscribe<std_msgs::Float64>
		(topic_name_tilt_angle, 10, tilt_cb);
